...
<div class="settings-tab">
  <input
    ...
    id="credibility-tab"
    name="settings-group"
    :checked="selectedTab == SettingsTab.CredibilityAnalyzer"
    v-on:change="selectTab(SettingsTab.CredibilityAnalyzer)"
  />
  <label name="tabName" for="credibility-tab">
    <img src="../assets/icons/settings.svg" height="30" />
    Credibility Analyzer
  </label>

  <div class="settings-content">
    <div class="main">
      <CredibilitySettings v-if="selectedTab == SettingsTab.CredibilityAnalyzer" />
    </div>
  </div>
</div>
...
import CredibilitySettings from '../components/CredibilitySettings.vue';
